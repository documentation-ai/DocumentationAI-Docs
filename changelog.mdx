...
---
<Update label="2026-04-29" description="AI Assistant, AI controls, analytics, and help center components" tags={["feature","improvement"]}>

  ## New features

  - [AI Assistant](/ai/ai-assistant) adds an Ask AI experience in your docs with grounded answers and citations. See [AI Credits](/ai/ai-credits) for usage and pricing.

  - [CollectionList](/components/collection-list) and [CollectionContent](/components/collection-content) help you build help center-style hubs and browseable topic pages.

  - [Cookie Consent](/customize/cookie-consent) adds consent controls for analytics and third-party scripts.

  ## Updates

  - [Search Configuration](/ai/search-configuration) adds controls for search behavior and AI answer quality.

  - [AI Privacy and Data Handling](/ai/ai-privacy-and-data) explains privacy and credit-usage controls for AI features.

  - [Search and AI Assistant Analytics](/analytics-and-insights/search-and-ai-assistant-analytics) shows searches, Ask AI usage, and common questions. See [Analytics overview](/analytics/overview) for the broader analytics view.

  - [Pages](/organize/pages) and [Groups](/organize/groups) explain how to add content pages to navigation containers.
