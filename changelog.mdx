...
---
<Update label="2026-04-27" description="AI Assistant settings improvements" tags={["feature","improvement"]}>
  ## AI Assistant settings

  The AI Assistant settings experience is now split into clearer sections for custom instructions, conversation starters, and response handling, making the configuration easier to scan and manage.

  You can now also control whether the assistant is enabled and whether it opens by default, giving you more flexibility over how the chat experience behaves for readers.

  Starter and fallback questions are now enabled by default for new setups, improving the out-of-box experience.

  The AI Assistant settings area is also available from the dashboard settings sidebar, so it is easier to find and configure.
</Update>
