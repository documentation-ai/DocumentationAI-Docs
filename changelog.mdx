...
<Update label="2026-03-24" description="Site Config in Editor, analytics and chat integrations, custom scripts, and unpublish support" tags={["feature","improvement"]}>
  ...
  Documentation configuration — theme, branding, SEO, navigation, integrations, scripts, and more — is now accessible directly from the Editor. Click **Site Config** in the Editor top toolbar. Changes appear in the Changes panel alongside content edits and deploy when you publish. Learn more in [Site Configuration](/customize/site-configuration).
  ...
  Add custom `.js` and `.mjs` scripts to your documentation site for tools not covered by built-in integrations. Add consent banners, tracking snippets, or any custom functionality by placing script files in your project. See [Custom Scripts](/customize/custom-scripts).
