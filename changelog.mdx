...
---
<Update label="2026-03-24" description="Site Config in Editor, analytics and chat integrations, custom scripts, and unpublish support" tags={["feature","improvement"]}>
  ## Site Config in Editor

  Documentation configuration — theme, branding, SEO, navigation, integrations, scripts, and more — is now accessible directly from the Editor. Click the **gear icon** in the Editor toolbar to open Site Config. Changes appear in the Changes panel alongside content edits and deploy when you publish. Learn more in [Site Configuration](/customize/site-configuration).

  ## Analytics and chat integrations

  Connect analytics platforms and chat widgets to your documentation with zero-code setup. Built-in support for 17 providers including Google Tag Manager, Google Analytics, PostHog, Amplitude, Mixpanel, Segment, Hotjar, Intercom, Crisp, and more. Just provide your project ID and publish. See [Analytics and Chat Integrations](/integrations-and-workflows/analytics-and-chat).

  ## Custom scripts

  Inject custom JavaScript into your documentation site for tools not covered by built-in integrations. Add consent banners, A/B testing scripts, or any third-party snippet with configurable load strategies. See [Custom Scripts](/customize/custom-scripts).

  ## Unpublish documentation

  Take your documentation site offline with a single click from Settings → Danger Zone. Content and configuration are preserved in the Editor for easy republishing at any time. See [Web Editor — Unpublish](/write-and-publish/web-editor#unpublish-your-documentation).
</Update>
