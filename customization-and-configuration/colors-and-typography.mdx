...
## Customize Colors from the Settings UI (recommended)

You can configure your brand, heading, and text colors directly from the Documentation.AI Settings UI without editing JSON.
...
3. Scroll down to the **Theme Colors** section.

All changes made here are stored under `theme.colors` in `documentation.json`. Publish your documentation to apply the changes.

<Image src="https://blob-cdn.documentation.ai/org-53a37986-2c9e-4094-b9e8-1e1ffae9e9ee/doc-b389b141-ae58-4fd5-91f9-6702fae9ac58/1764935355006-tgrlzl4ljj9-pasted-image-1764935353293.png?q=85&fm=auto&auto=compress%2Cformat" width="3810" height="1534" alt="" />

### Step 2: Configure Light Theme Colors

In the **Light Theme** column, you can configure:
...
- **Text**\
  Controls the main body text color for optimal readability on light backgrounds.

Use valid hex color codes (for example, `#1a1a1a`) and ensure sufficient contrast between text and background.

### Step 3: Configure Dark Theme Colors

In the **Dark Theme** column, you can configure:

- **Brand**\
  Sets a lighter/brighter version of your brand color for interactive elements in dark mode.

- **Heading**\
  Controls heading and title colors for dark backgrounds. Choose a color with high contrast.

- **Text**\
  Defines the primary body text color in dark mode. Aim for comfortable contrast and readability.
...
If you need more granular or automated control, you can also configure these colors directly `documentation.json` as described below.
