...
description: "Configure URL redirects to manage page moves, URL changes, and legacy paths in your documentation site."
---
...
<ExpandableGroup>
<Expandable title="Keep redirects organized">
...
<Expandable title="Use permanent redirects for SEO">
...
<Expandable title="Test redirects before deploying">
...
<Expandable title="Avoid redirect chains">
...
<Expandable title="Monitor redirect performance">
...
<ExpandableGroup>
<Expandable title="Redirect not working">
...
<Expandable title="Wrong destination URL">
...
<Expandable title="Redirect loops">
...
<Expandable title="Dynamic parameters not working">
...
[Deploy Your Documentation](deploy-your-documentation) - Complete deployment guide
[Custom Domain Setup](custom-domain) - Connect your own domain
[Custom Subpath Setup](custom-subpath/overview) - Host documentation at a subpath
[Site Configuration](../customization-and-configuration/site-configuration) - Configure your documentation site