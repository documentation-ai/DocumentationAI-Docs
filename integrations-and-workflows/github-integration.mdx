...
<ExpandableGroup>
  ...
  <Expandable title="Reached the maximum of 2 context repositories" default-open="false">
    ...
    If you consistently need more than two repositories for context, consider splitting your docs into multiple projects that mirror your codebase structure or contact sales at [hello@documentationai.com](mailto:hello@documentationai.com) to request higher limits.
  </Expandable>
</ExpandableGroup>
