...
- [Headings and Text](https://documentation.documentationai.io/components/heading-and-text.md): Reference for headings, paragraphs, inline styles, links, and spacing in MDX.

- [Lists and Tables](https://documentation.documentationai.io/components/lists-and-tables.md): Reference for creating ordered lists, unordered lists, nested lists, and tables in MDX.

- [Card](https://documentation.documentationai.io/components/card.md): Reference for creating interactive cards with icons, images, and call-to-action buttons using the Card component.

- [Images](https://documentation.documentationai.io/components/images.md): Reference for adding images using the Image component and markdown syntax.

- [Videos and iframes](https://documentation.documentationai.io/components/videos-and-iframes.md): Reference for embedding videos and iframes using the Video and Iframe components.

- [Code blocks and groups](https://documentation.documentationai.io/components/code-blocks-and-groups.md): Reference for displaying syntax-highlighted code with copy functionality and organizing multiple code examples in tabbed interfaces.

- [Mermaid Diagrams](https://documentation.documentationai.io/components/mermaid.md): Reference for creating interactive diagrams using Mermaid syntax with automatic theme support and zoom controls.

- [Callout](https://documentation.documentationai.io/components/callout.md): Reference for displaying highlighted information and alerts using the Callout component.

- [Expandables](https://documentation.documentationai.io/components/expandables.md): Reference for creating collapsible content sections using Expandable and ExpandableGroup components.

- [Param Field](https://documentation.documentationai.io/components/paramfield.md): Reference for documenting API parameters with location badges, types, and status indicators.

- [Response Field](https://documentation.documentationai.io/components/responsefield.md): Reference for documenting API response fields with types, requirements, and status indicators.

- [API Components](https://documentation.documentationai.io/components/api-components.md): Reference for Request and Response components that automatically display in the right panel for API documentation.
...
Any configuration to the documentation site has to be done using the `documentation.json` file. This file controls your site's branding, navigation structure, SEO settings, and API documentation generation for detailed reference use the below site configuration [https://documentation.documentationai.io/customization-and-configuration/site-configuration](https://documentation.documentationai.io/customization-and-configuration/site-configuration)
