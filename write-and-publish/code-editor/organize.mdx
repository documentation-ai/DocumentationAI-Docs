...
<Callout type="info">
**AI Assistant Users**: If you're using Cursor, Windsurf, or similar AI coding agents, use our [configuration prompts](../prompts#configuration-prompt) to help generate proper `documentation.json` navigation structures and page configurations.
</Callout>
...
**Sibling directory**: `[API Auth](../api-documentation-and-playground/api-authentication)`  
