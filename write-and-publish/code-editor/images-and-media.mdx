...
<Callout type="tip">
**AI Coding Agents**: When using Cursor, Windsurf, or other AI assistants, leverage our [component prompts](../prompts#components-prompt) to generate proper Documentation.AI Image and Video component syntax with all required attributes.
</Callout>
