...
Use the [web editor](/write-and-publish/web-editor/overview) for:
...
<Callout type="tip">
**AI Coding Agents**: If you're using AI coding assistants like Cursor or Windsurf, check out our [helpful prompts](/write-and-publish/prompts) to generate Documentation.AI-compatible content with proper component syntax and formatting.
</Callout>
...
For visual editing and real-time collaboration, try the [web editor](/write-and-publish/web-editor/overview).
