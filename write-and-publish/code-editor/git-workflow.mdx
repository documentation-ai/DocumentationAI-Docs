...
**VS Code**: Use Source Control panel (<kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>G</kbd>)  
...
<Callout type="tip">
**AI-Enhanced Workflow**: If you're using AI coding agents like Cursor or Windsurf to help write documentation, use our [helpful prompts](/write-and-publish/prompts) to generate content that follows Documentation.AI conventions and includes proper component formatting.
</Callout>
