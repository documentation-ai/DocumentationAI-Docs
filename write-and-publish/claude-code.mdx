...
Transform Claude Code into a documentation expert that understands your components, style guide, and best practices.
...
For complete documentation.json reference, see the [Site Configuration](/customize/site-configuration) documentation.
