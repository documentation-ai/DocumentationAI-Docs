...
- You need a **hub page** that uses [Collection components](/components/collection) to showcase everything in the group
...
<Steps>
  ...
  <Step title="Write the content" icon="pen-tool" title-type="p">
    The group now opens its content page when clicked. Write your overview, add [Collection components](/components/collection), or use any other MDX content.
  </Step>
</Steps>
