...
- **Dropdown hub pages** – A dropdown for "Integrations" could have a content page listing supported integrations with a [CollectionList](/components/collection) component.
...
4. The view now opens its content page when clicked. Write your content or add [Collection components](/components/collection).
