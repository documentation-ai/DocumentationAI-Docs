...
Use content pages to create landing pages, section overviews, or hub pages that use [Collection components](/components/collection) to display child pages automatically. When a container has a content page, its label becomes a clickable link in breadcrumbs and navigation.
