...
- **Landing pages** – Attach a content page to a group to create a section overview. Use [Collection components](/components/collection) to display the group's children automatically.
