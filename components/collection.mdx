...
title: Collection
description: >-
  Reference for displaying navigation children as cards, lists, accordions, or
  nested trees using the CollectionList and CollectionContent components.
type: reference
---
...
- **Code Editor (MDX)** – Use the `<CollectionList>` and `<CollectionContent>` components.
...
- **Combine with content pages on containers**
  If your groups or tabs have [content pages attached](/organize/groups#content-pages-on-groups), you can use a collection component on that content page to create a self-maintaining hub.
