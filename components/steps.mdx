...
## Using Steps in the editor UI

### Add a steps block

<Steps>
  <Step title="Place your cursor where you want the steps to appear." title-type="p">

  </Step>

  <Step title="Type &#x22;/&#x22; and search for &#x22;Steps.&#x22;" title-type="p">

  </Step>

  <Step title="Select &#x22;Steps&#x22; to insert a steps block with one step." title-type="p">
