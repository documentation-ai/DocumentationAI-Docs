...
<Columns cols={2}>
  <Card title="Getting Started" href="/getting-started/quickstart" icon="book-open">
    Learn the fundamentals and get your project up and running in minutes.
  </Card>

  <Card title="API Reference" href="/api-documentation-and-playground/api-authentication" icon="code">
...
<Image src="https://blob-cdn.documentation.ai/org-53a37986-2c9e-4094-b9e8-1e1ffae9e9ee/doc-b389b141-ae58-4fd5-91f9-6702fae9ac58/1765030391396-u88yxy8jal-pasted-image-1765030390682.png?q=85&fm=auto&auto=compress%2Cformat" width="282" height="403" alt="Card settings panel in the Web Editor" style="width: 282px; height: auto; cursor: pointer;" />
...
<Image src="https://blob-cdn.documentation.ai/org-53a37986-2c9e-4094-b9e8-1e1ffae9e9ee/doc-b389b141-ae58-4fd5-91f9-6702fae9ac58/1765030485990-6wmojffkkfh-pasted-image-1765030484611.png?q=85&fm=auto&auto=compress%2Cformat" width="372" height="242" alt="Card Group with two cards in the Web Editor" style="width: 372px; height: auto; cursor: pointer;" />
...
<Columns cols={3}>
  ...
  <Card title="Performance" icon="zap" href="/help/fix-performance-issues">
