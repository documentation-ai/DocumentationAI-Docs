...
description: >-
  ...
  call-to-action buttons using the Card component.
type: reference
---
## Overview
...
<Card title="Team Collaboration" href="/account-and-billing/team-management" icon="users">
  Work together seamlessly with role-based access control.
</Card>
...
<Card title="Analytics Dashboard" href="/analytics-and-insights/user-analytics" icon="bar-chart" cta="Explore">
  Track user behavior and monitor application metrics in real-time.
</Card>
...
<Columns cols="2">
  ...
  <Card title="Configuration" href="/customization-and-configuration/site-configuration" icon="settings" horizontal="false">
    Customize every aspect of your application.
  </Card>
</Columns>
