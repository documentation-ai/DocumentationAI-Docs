...
Displays animated skeleton while diagram renders:

<Callout kind="info">
  The skeleton loader provides visual feedback during diagram initialization and rendering.
</Callout>

### Error handling

If a diagram fails to render, a friendly error message appears:
...
<Callout kind="warning">
  Verify your Mermaid syntax if diagrams fail to render. Use the [Mermaid Live Editor](https://mermaid.live) to test syntax.
</Callout>
