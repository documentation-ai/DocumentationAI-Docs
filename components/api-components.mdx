...
You can duplicate or delete the whole Request block using the icons on the right.
...
You can duplicate or delete the whole Response block using the icons on the right.
