...
Use `Request` to display API request examples in the right sidebar. This component works like [CodeGroup](code-blocks-and-groups) but displays in the sidebar instead of inline.
