...
<Columns cols={3}>
  ...
  <Card title="Flexible" icon="grid" href="#">
    Support for 2, 3, 4, or 5 column layouts.
  </Card>
...
Maximum density for compact navigation or icon grids:

````jsx
<Columns cols={5}>
  <Card title="JavaScript" icon="code" href="#" horizontal>
    Learn JavaScript basics.
  </Card>
  <Card title="Python" icon="code" href="#" horizontal>
    Master Python development.
  </Card>
  <Card title="Go" icon="code" href="#" horizontal>
    Explore Go programming.
  </Card>
  <Card title="Rust" icon="code" href="#" horizontal>
    Build with Rust.
  </Card>
  <Card title="TypeScript" icon="code" href="#" horizontal>
...
<Callout kind="tip">
  Use horizontal cards with 4 or 5 columns for better content fit on desktop screens.
</Callout>
...
| Screen Size | cols={2} | cols={3} | cols={4} | cols={5} |
|-------------|----------|----------|----------|----------|
| Mobile      | 1 column | 1 column | 1 column | 1 column |
| Tablet      | 2 columns | 2 columns | 2 columns | 2 columns |
| Desktop     | 2 columns | 3 columns | 4 columns | 5 columns |
...
<ParamField path="cols" param-type="number" required="false" showLocation="false">
  Number of columns: `1`, `2`, `3`, `4`, or `5`. Defaults to `1` if not specified.
</ParamField>
...
- **Resource links** - 3-5 columns for external resources or tools
...
- **Integration showcase** - 4-5 columns for logos or integration cards
