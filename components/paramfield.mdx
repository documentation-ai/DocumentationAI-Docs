...
## Using ParamField in the editor UI
...
3. Select the **Param Field** to insert the component.
...
<Callout kind="tip" collapsed="false">
  Want to hide the location badge entirely? This is currently controlled in MDX using showLocation="false".\
  You can either switch to MDX view or ask the AI Agent to “hide the location badge for this parameter” and let it update the code for you.
</Callout>

## Using ParamField in the MDX
...
<ParamField query="showLocation" param-type="string" required="false" deprecated="false">
