...
---
<Image src="https://blob-cdn.documentation.ai/org-53a37986-2c9e-4094-b9e8-1e1ffae9ac58/1772193535712-h5byaxdfg4-Screenshot-2026-02-27-at-5-28-43-PM.png?q=85&fm=auto&auto=compress%2Cformat" width="1924" height="872" alt="" />
...
<Callout kind="info" collapsed="false">
  Configure Page Actions either from the Dashboard or by editing your configuration file:

  - Use the **Dashboard Page Actions settings** to choose which quick actions appear.

  - Update the **`ai.page-actions`** key in your `documentation.json` file if you prefer to manage settings in code.

  Changes to Page Actions are stored under `ai.page-actions` in `documentation.json`. After updating these settings in the Dashboard or in code, publish your documentation in the editor so the changes apply to your live site.
</Callout>
...
<Image src="https://blob-cdn.documentation.ai/org-53a37986-2c9e-4094-b9e8-1e1ffae9e9ee/doc-b389b141-ae58-4fd5-91f9-6702fae9ac58/1772193535712-h5byaxdfg4-Screenshot-2026-02-27-at-5-28-43-PM.png?q=85&fm=auto&auto=compress%2Cformat" width="1924" height="872" alt="" />

Use the Page Actions settings in the Dashboard -> Settings -> General -> Page Actions to manage configuration.

- You can enable or disable the options you want

- If you want to completely remove Page Actions itself, you can disable all.&#x20;

Please ensure that you publish the documentation after you make this changes.&#x20;
