...
- Suggested follow-up questions they can click to continue the conversation

- One or more citations linked to specific pages (often down to the section)

- Links that clearly distinguish internal documentation navigation from external destinations
...
3. The assistant searches your docs, reasons over the results, and responds with:
   ...
   - Suggested follow-up questions users can click to keep exploring the topic

   - Optional step-by-step guidance

   - Citations and links to relevant pages or sections, with internal docs links distinguished from external links
