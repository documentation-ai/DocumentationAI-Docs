...
The AI Assistant helps readers, customers, and internal teams get fast, accurate answers based on your published documentation. When someone opens **Ask AI**—either manually or because it opens by default based on your site settings—the assistant searches your docs, reasons over the content it finds, and returns grounded answers with citations. Search can also better match relevant section titles, not just page body content.

Admins manage the assistant at the site level. You can enable or disable it for each documentation site, choose whether it opens by default, and rely on follow-up questions being enabled by default.
...
If the AI Assistant is enabled for the site, it appears in your documentation as an **Ask AI** entry point. Depending on your site settings, readers can open it manually or see it open by default.
...
<Callout kind="info" collapsed="false">
  Manage the AI Assistant in your site settings. You can enable or disable it per site, choose whether it opens by default, and keep follow-up questions on with the default configuration.
</Callout>
