...
- Suggested follow-up questions that can appear as clickable prompts when the assistant identifies useful next questions
...
2. They type a question in natural language using the chat input. Voice input is no longer available.
...
3. The assistant searches your docs, reasons over the results, and responds with:
   ...
   - Suggested follow-up questions rendered as clickable prompts
