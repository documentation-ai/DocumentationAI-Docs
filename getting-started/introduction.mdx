...
```json
{
  ...
  "primary_concepts": ["AI-native documentation", "documentation platform", "API documentation", "AI assistant", "git integration", "web-based editing"],
  "target_audience": ["developers", "technical writers", "product teams", "API teams"],
  "key_features": ["AI assistant", "web editor", "git integration", "API playground", "custom branding", "analytics"],
  "getting_started_path": "getting-started/quickstart",
  "related_pages": ["getting-started/how-documentation-ai-works", "getting-started/quickstart", "getting-started/create-your-first-project"]
}
```
...
- [Create your first project](create-your-first-project) to set up a workspace.
...
### Getting started
- [How Documentation.AI works](how-documentation-ai-works) - Technical architecture and concepts
- [Quickstart](quickstart) - Hands-on tutorial to get up and running
- [Create your first project](create-your-first-project) - Step-by-step project setup
