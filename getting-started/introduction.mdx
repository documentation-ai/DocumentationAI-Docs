...
- **Technical writers** managing large-scale [documentation projects](../write-and-publish/organize-content-structure)
...
Content is authored in [MDX](../write-and-publish/markdown-basics) (Markdown with React components), providing the simplicity of Markdown with the power of interactive components. This approach enables rich, interactive documentation while maintaining content portability.
...
- **[Web editor](../write-and-publish/web-editor)** with WYSIWYG and markdown modes for browser-based editing
...
- **[Version control](../write-and-publish/content-versioning-and-history)** with content history and git-based versioning
- **[Image and media management](../write-and-publish/images-and-media)** with optimization
...
- **[Theme customization](../customization-and-configuration/theme)** for light and dark modes
- **[Navigation configuration](../customization-and-configuration/navigation-and-sidebar)** with flexible sidebar structure
- **[Custom CSS and JavaScript](../customization-and-configuration/custom-css-and-javascript)** for advanced customization
