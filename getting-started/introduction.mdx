...
<Card title="Core Concepts" icon="lightbulb" href="core-concepts" cta="Learn More">
...
<Columns cols={2}>
<Card title="Quickstart Tutorial" icon="play" href="quickstart" cta="Start Now">
  Get hands-on and build your first documentation site in minutes.
</Card>
<Card title="Import Existing Docs" icon="upload" href="import-existing-docs" cta="Migrate">
  Bring your existing documentation from other platforms.
</Card>
<Card title="Configure Branding" icon="palette" href="../customization-and-configuration/branding" cta="Customize">
  Match your documentation to your product's visual identity.
</Card>
<Card title="Deploy to Production" icon="globe" href="../deployment-and-hosting/deploy-your-documentation" cta="Go Live">
