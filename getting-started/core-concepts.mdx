...
```json
{
  ...
  "related_pages": [
    ...
    "write-and-publish/web-editor",
    "ai/ai-assistant-set-up",
    "configuration/documentation-json-site-configuration"
  ]
}
```
...
## Web and git workflows
- Web editor: collaborative, visual, component-aware. See [Web editor](../write-and-publish/web-editor).
...
- [Site configuration](../configuration/documentation-json-site-configuration)
