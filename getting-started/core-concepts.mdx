...
Being AI native means Documentation.AI uses AI and AI-integrated features throughout the product to support both writers and readers. Structured components still matter, but they are only one part of a broader, AI‑driven workflow.

- **AI Agent for writing and maintenance**: Helps draft, rewrite, and refine content in the web editor.

- **AI Assistant for readers**: Provides context-aware answers sourced from your documentation. See [Set Up the AI Assistant](/ai/ai-assistant).

- **On-page AI features**: Includes quick actions such as copy helpers and the AI menu for fast explanations. See [On-Page AI Menu](/ai/ai-menu).
...
- **And more**: llms-txt, best practice etc
...
- Use built-in AI agent to write documentation effortlessly.&#x20;
