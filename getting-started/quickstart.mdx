...
6. Add components by typing "/" commands (e.g., /callout, /card, /mermaid, /codegroup)
...
<Columns cols={2}>
<Card title="Import API Schema" icon="code" href="../api-documentation-and-playground/openapi-import" cta="Import Now">
  Auto-generate API reference pages from your OpenAPI specification.
</Card>
<Card title="Configure Analytics" icon="bar-chart" href="../analytics-and-insights/user-analytics" cta="Set Up">
