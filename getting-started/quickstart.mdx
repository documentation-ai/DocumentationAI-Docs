...
```json
{
  ...
  "related": ["getting-started/core-concepts", "writing-content/web-editor", "ai/ai-assistant-set-up", "deployment-and-hosting/deploy-your-documentation"]
}
```
...
<CodeGroup tabs="Pages to Create,Navigation Structure">
```markdown
Pages to Create:
...
<CodeGroup tabs="Web-Based Editor,Code/IDE Workflow">
```markdown
...
<CodeGroup tabs="Web Editor Components,Code/IDE Components">
```markdown
Web-Based Block Editor:
...
<CodeGroup tabs="Documentation.AI Hosting,Custom Domain">
```markdown
...
### Essential features  
- [Web editor](../writing-content/web-editor) - Master the editing interface
