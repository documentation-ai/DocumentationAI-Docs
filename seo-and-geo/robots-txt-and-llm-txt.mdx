...
Documentation.AI exposes a `robots.txt` file at `/robots.txt` on your live docs site and includes robots directives for indexing and following links. You configure these directives from the **SEO** section in Site Config (gear icon in the Editor) or directly in `documentation.json`.
...
<Steps>
  <Step title="Open Site Config" icon="settings" title-type="p">
    In the Editor, click the **gear icon** in the toolbar to open **Site Config**, then scroll to the **SEO** section.
  </Step>
