...
description: Import OpenAPI 3.0+ specifications to automatically generate comprehensive API documentation with interactive examples.
---

```json
{
  "summary": "Import OpenAPI specifications to generate API documentation",
  "primaryAction": "import_openapi_spec",
  "requiredFiles": ["openapi.json", "openapi.yaml"],
  "configLocation": "documentation.json",
  "supportedVersions": ["3.0.0", "3.0.1", "3.0.2", "3.0.3", "3.1.0"],
  "outputFormat": "mdx_files"
}
```
...
<ParamField path="openapi" param-type="string" required="true" showLocation="false">
...
<CodeGroup tabs="YAML Format,JSON Format">
...
<ParamField path="apiKey" param-type="object" required="false" showLocation="false">
  API key authentication in headers, query, or cookies.
</ParamField>

<ParamField path="http" param-type="object" required="false" showLocation="false">
  HTTP authentication including Basic and Bearer token schemes.
</ParamField>

<ParamField path="oauth2" param-type="object" required="false" showLocation="false">
  OAuth 2.0 flows with automatic authorization URL generation.
</ParamField>

<ParamField path="openIdConnect" param-type="object" required="false" showLocation="false">
