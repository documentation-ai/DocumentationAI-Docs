  ...
  "pages": [
    {
      ...
      "openapi": "api/openapi.yaml GET /users/{id}"
    }
  ]
}
```
...
<ParamField path="openapi" param-type="string" required="false" deprecated="false">
  Connects a specific OpenAPI endpoint to this page. Format: `"filepath METHOD /endpoint"` (e.g., `"api/openapi.yaml GET /users/{id}"`). The method must be uppercase.
</ParamField>
        ...
        "pages": [
          {
            ...
            "openapi": "api/openapi.yaml GET /health",
            "openapi-mode": "custom"
          }
        ]
      }
