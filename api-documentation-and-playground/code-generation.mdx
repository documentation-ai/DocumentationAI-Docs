...
description: Automatically generate client code examples in multiple programming languages from OpenAPI specifications with customizable templates.
---

```json
{
  "summary": "Generate client code examples automatically from OpenAPI specifications",
  "primaryAction": "generate_code_samples",
  "supportedLanguages": ["javascript", "python", "curl", "go", "php", "ruby", "java", "csharp"],
  "features": ["automatic_generation", "custom_templates", "authentication_handling", "error_handling"],
  "configLocation": "openapi_specification"
}
```
...
<Request tabs="JavaScript,Python,cURL,Go">
```javascript
