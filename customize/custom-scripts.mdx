...
---
Inject custom JavaScript into your published documentation site. Use custom scripts for analytics providers not covered by [built-in integrations](/integrations-and-workflows/analytics-and-chat), consent banners, A/B testing tools, or any custom functionality.
...
| -------- | ---- | -------- | ----------- |
| `src` | string | Yes | Relative file path to a `.js` or `.mjs` file in your project |
