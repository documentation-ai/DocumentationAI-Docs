...
<Image src="https://blob-cdn.documentation.ai/org-53a37986-2c9e-4094-b9e8-1e1ffae9e9ee/doc-b389b141-ae58-4fd5-91f9-6702fae9ac58/1774540946311-34bnwmxka4x-access_control--1-.jpg?q=85&fm=auto&auto=compress%2Cformat" width="2776" height="1549" alt="Access control settings in the Documentation.AI dashboard showing Public, Private, and Partial access mode options" />

<Callout kind="alert" collapsed="false">
  If you store your documentation source in your own Git repository, keep that repository private so the source content is not publicly visible. This is especially important when you use Partial mode or protected pages. Access control settings (Public, Private, Partial, and Protected pages) apply only to the deployed documentation site, not to the visibility of your Git repository.
</Callout>
...
<Image src="https://blob-cdn.documentation.ai/org-53a37986-2c9e-4094-b9e8-1e1ffae9e9ee/doc-b389b141-ae58-4fd5-91f9-6702fae9ac58/1774541673115-277l9uksh6p-password.jpg?q=85&fm=auto&auto=compress%2Cformat" width="1570" height="869" alt="Authentication methods configuration in Documentation.AI showing Password, JWT, and OAuth 2.0 options" />
...
<Tabs>
  <Tab title="Password" icon="key">
    ...
    <Steps>
      <Step title="Choose an access mode" icon="shield-check" title-type="p">
      ...
      <Step title="Re-publish to apply changes" icon="upload" title-type="p">
  ...
  <Tab title="JWT" icon="key-round">
    ...
    <Steps>
      <Step title="Configure JWT settings in the dashboard" icon="settings" title-type="p">
      ...
      <Step title="Integrate the docs callback into your login flow" icon="arrow-right" title-type="p">
      ...
      <Step title="Preserve the user's intended destination (recommended)" icon="map" title-type="p">
  ...
  <Tab title="OAuth 2.0" icon="shield">
    ...
    <Steps>
      <Step title="Configure OAuth in the dashboard" icon="settings" title-type="p">
        In your dashboard, go to **Settings → Access Control** and select **Private** or **Partial** mode.
      ...
      <Step title="Register the redirect URL with your provider" icon="link" title-type="p">
