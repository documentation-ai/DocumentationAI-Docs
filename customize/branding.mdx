...
<Image src="https://blob-cdn.documentation.ai/org-53a37986-2c9e-4094-b9e8-1e1ffae9e9ee/doc-b389b141-ae58-4fd5-91f9-6702fae9ac58/1774533114694-1gh6yvi2eds-favicon.jpg?q=85&fm=auto&auto=compress%2Cformat" width="3000" height="1638" alt="Brand & Theme settings in the Documentation.AI editor showing upload fields for dark theme logo, light theme logo, and favicon" />
<p style={{ textAlign: "center", fontSize: "14px", color: "gray", marginTop: "-8px" }}>Brand & Theme settings showing upload fields for dark theme logo, light theme logo, and favicon</p>
