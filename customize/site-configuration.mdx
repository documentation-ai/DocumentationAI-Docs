...
<Callout kind="alert" collapsed="false">
  This page is primarily intended for Code/IDE-based editing. Most of these settings can also be configured from the dashboard UI, please visit the relevant section for those options.
</Callout>

## Site Configuration

Complete schema for the `documentation.json`  is available at <a href="https://dashboard.documentation.ai/documentation.json" target="_blank" rel="noopener noreferrer">https\://dashboard.documentation.ai/documentation.json</a>&#x20;
