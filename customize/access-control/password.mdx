...
<Steps>
  <Step title="Choose Private mode" icon="lock" title-type="p">
    In your dashboard, go to **Settings > Access Control** and select **Private**.
  </Step>

  <Step title="Select Password method" icon="key" title-type="p">
    In **Authentication Method**, choose **Password**.
  </Step>

  <Step title="Choose protection scope" icon="shield-check" title-type="p">
