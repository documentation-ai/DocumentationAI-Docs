...
| Method | Plan | User-level access | Personalization |
|---|---|---|---|
| [Password](/docs/customize/access-control/password) | Standard+ | No (shared password) | No |
| [JWT](/docs/customize/access-control/jwt) | Enterprise+ | Yes (per-user roles) | Yes |
| [OAuth 2.0](/docs/customize/access-control/oauth) | Enterprise+ | Yes (per-user roles) | Yes |
