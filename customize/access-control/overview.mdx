...
| --------------------------------------------------- | ----------- | ---------------- | -------------------- | --------------- |
| [Password](/customize/access-control/password) | Standard+   | Private, Partial | No (shared password) | No              |
| [JWT](/customize/access-control/jwt)           | Enterprise+ | Private          | Yes (per-user roles) | Yes             |
| [OAuth 2.0](/customize/access-control/oauth)   | Enterprise+ | Private          | Yes (per-user roles) | Yes             |
