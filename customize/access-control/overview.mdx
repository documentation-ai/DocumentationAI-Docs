...
| Method                                              | Plan        | Available in     | User-level access    | Personalization |
| --------------------------------------------------- | ----------- | ---------------- | -------------------- | --------------- |
| [Password](/docs/customize/access-control/password) | Standard+   | Private, Partial | No (shared password) | No              |
| [JWT](/docs/customize/access-control/jwt)           | Enterprise+ | Private          | Yes (per-user roles) | Yes             |
| [OAuth 2.0](/docs/customize/access-control/oauth)   | Enterprise+ | Private          | Yes (per-user roles) | Yes             |
...
[Set up password authentication ->](/docs/customize/access-control/password)
...
[Set up JWT authentication ->](/docs/customize/access-control/jwt)
...
[Set up OAuth 2.0 authentication ->](/docs/customize/access-control/oauth)
