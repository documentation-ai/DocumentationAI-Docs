...
Deploy your documentation at a custom subpath such as `yoursite.com/docs` using Vercel's powerful rewrite functionality. This guide walks you through configuring your Vercel project to proxy requests from your chosen subpath to your documentation hosting.
...
Your documentation files must be organized to match your chosen subpath. For example, if you want documentation at `yoursite.com/docs`, organize your repository accordingly:
...
<Callout kind="alert">
  Replace `[SUBDOMAIN]` with your actual subdomain from Documentation.AI, and adjust `/docs` to your preferred subpath if different.
</Callout>
...
<Steps>
  <Step title="Test Root Path" icon="home">
