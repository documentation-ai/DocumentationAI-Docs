...
<Callout kind="info">
  **Flexible Subpath**: Throughout this guide, we use <kbd>/docs</kbd> as an example, but you can use any subpath such as <kbd>/help</kbd>, <kbd>/guide</kbd>, <kbd>/documentation</kbd>, <kbd>/api-docs</kbd>, or <kbd>/support</kbd>. Simply replace <kbd>/docs</kbd> with your chosen path in all configuration examples.
</Callout>

<Callout kind="info">
  Before you begin, ensure your main site is already deployed on Vercel and your documentation is accessible at <kbd>[SUBDOMAIN].documentationai.io</kbd>.
</Callout>
...
<Callout kind="alert">
  **Important Replacements:**
  - Replace <kbd>[SUBDOMAIN]</kbd> with your actual subdomain from Documentation.AI
  - Replace <kbd>[SUBPATH]</kbd> with your chosen subpath (e.g., <kbd>/docs</kbd>, <kbd>/help</kbd>, <kbd>/guide</kbd>, <kbd>/documentation</kbd>)
