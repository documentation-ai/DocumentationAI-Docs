...
<Callout kind="info">
  Requires: Cloudflare account, domain on Cloudflare, documentation at <kbd>[SUBDOMAIN].documentationai.io</kbd>
</Callout>
...
<Callout kind="alert">
  Replace: <kbd>[SUBDOMAIN]</kbd> with your subdomain, <kbd>[YOUR_DOMAIN]</kbd> with your domain, <kbd>/docs</kbd> with your path.
</Callout>
...
<Callout kind="tip">
  Change <kbd>/docs</kbd> on line 17 to your path (e.g., <kbd>/help</kbd>, <kbd>/api-docs</kbd>).
</Callout>
